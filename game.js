...
function loop() {
    ...
    // now we would need to add an collisin check to display our end-menu
    // and end the game
    ...
    pipeX -= 1.5;
    // if the pipe move out of the frame we need to reset the pipe
    if (pipeX < -50) {
        pipeX = 400;
